...
model = load_model(r"C:\Users\saira\Desktop\voice base gender detection\results\model.h5")  # Assuming this loads your model, replace with your actual loading logic
...
if gender == "male":
    image_path = r"C:\Users\saira\Desktop\voice base gender detection\male.png"  # Path to the male image file
else:
    image_path = r"C:\Users\saira\Desktop\voice base gender detection\female.png"  # Path to the female image file
